...
public class AnglerDbAdapter {
	...
	public static final String [] INSERT_DATA_lakes = new String [] {
		"INSERT INTO LAKES values (1,'Allatoona Lake',0,0," + R.drawable.allatoona_lake + ",44.957528,-70.982218,60,31,6700,1518,'Boat Launch - Trailerable','Sturgeon: Catch and Release','Spotted bass, white bass & crappie');",
		"INSERT INTO LAKES values (2,'Andrews Lake',0,0," + R.drawable.andrews_lake + ",44.896713,-70.990383,32,11,12,2056,'Boat Launch - Hand Carry','No Live Fish As Bait','Ice Fishing Closed');",
		"INSERT INTO LAKES values (3,'Bartletts Ferry Lake',0,0," + R.drawable.bartletts_ferry_lake + ",44.743176,-70.959371,110,29,471,1389,'No Boat Launch','Artificial Lures Only','Ice Fishing Closed');",
		"INSERT INTO LAKES values (4,'Blue Ridge Lake',0,0," + R.drawable.blue_ridge_lake + ",45.216643,-70.548539,27,6,22,1407,'No Boat Launch','No Live Fish As Bait','Ice Fishing Closed');",
		"INSERT INTO LAKES values (5,'Carters Lake',0,0," + R.drawable.carters_lake + ",44.903914,-70.410228,17,6,32,1337,'Boat Launch - Hand Carry','Fly Fishing Only','Ice Fishing Closed');",
		"INSERT INTO LAKES values (6,'Lake Blackshear',0,0," + R.drawable.lake_blackshear + ",44.900305,-70.612432,52,22,543,1729,'Boat Launch - Trailerable','No Live Fish As Bait','Ice Fishing Closed');",
		"INSERT INTO LAKES values (7,'Lake Burton',0,0," + R.drawable.lake_burton + ",44.897112,-70.939117,72,20,179,1489,'Boat Launch - Hand Carry','Fly Fishing Only','Ice Fishing Closed');",
		"INSERT INTO LAKES values (8,'Lake Lanier',0,0," + R.drawable.lake_lanier + ",45.260890,-70.776259,20,8,20,1991,'No Boat Launch','Fly Fishing Only','Ice Fishing Closed');",
